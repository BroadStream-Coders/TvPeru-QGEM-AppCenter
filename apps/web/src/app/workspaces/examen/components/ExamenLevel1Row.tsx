...
export interface ExamenLevel1RowData {
  id: string;
  question: string;
  answerL: string;
  answerR: string;
...
interface ExamenLevel1RowProps {
  index: number;
  data: ExamenLevel1RowData;
  onChange: (updates: Partial<ExamenLevel1RowData>) => void;
  onRemove: () => void;
}

export function ExamenLevel1Row({
  index,
  data,
  onChange,
  onRemove,
}: ExamenLevel1RowProps) {
  return (
